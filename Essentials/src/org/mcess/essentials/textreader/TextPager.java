	...
	public void showPage(final String pageStr, final String chapterPageStr, final String commandName, final CommandSource sender)
	{
		...
		if (pageStr == null || pageStr.isEmpty() || pageStr.matches("[0-9]+"))
		{
			...
			if (!lines.isEmpty() && lines.get(0).startsWith("#"))
			{
				...
				sender.sendMessage(I18n.tl("infoChapter"));
			...
			else
			{
				...
				if (!onePage && commandName != null)
				{
					...
					sender.sendMessage(I18n.tl("infoPages", page, pages, content));
				}
				...
				{
					sender.sendMessage(I18n.tl("readNextPage", commandName, page + 1));
				}
				return;
			}
		}
		...
		{
			sender.sendMessage(I18n.tl("infoUnknownChapter"));
			return;
		}
		...
		if (!onePage && commandName != null)
		{
			...
			sender.sendMessage(I18n.tl("infoChapterPages", content, page, pages));
		}
		...
		if (!onePage && page < pages && commandName != null)
		{
			sender.sendMessage(I18n.tl("readNextPage", commandName, pageStr + " " + (page + 1)));
		}
	}
}
