	...
	protected boolean onSignBreak(final ISign sign, final User player, final String username, final IEssentials ess) throws SignException, MaxMoneyException
	{
		...
		if (canBreak)
		{
			try
			{
				...
				final Map<Integer, ItemStack> withdraw1 = stored1.pay(player, Trade.OverflowType.RETURN);
				final Map<Integer, ItemStack> withdraw2 = stored2.pay(player, Trade.OverflowType.RETURN);
