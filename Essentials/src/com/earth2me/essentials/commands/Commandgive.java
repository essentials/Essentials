...
public class Commandgive extends EssentialsCommand
{
	...
	public void run(final Server server, final CommandSource sender, final String commandLabel, final String[] args) throws Exception
	{
		...
		{
			throw new Exception(tl_("cantSpawnItem", itemname));
		}
		...
		{
			throw new Exception(tl_("cantSpawnItem", "Air"));
		}

		final String itemName = stack.getType().toString().toLowerCase(Locale.ENGLISH).replace('_', ' ');
		sender.sendMessage(tl_("giveSpawn", stack.getAmount(), itemName, giveTo.getDisplayName()));
		...
		{
			sender.sendMessage(tl_("giveSpawnFailure", item.getAmount(), itemName, giveTo.getDisplayName()));
		}
