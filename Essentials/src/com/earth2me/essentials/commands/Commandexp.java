...
public class Commandexp extends EssentialsCommand
{
	...
	{
		sender.sendMessage(tl_("exp", target.getDisplayName(), SetExpFix.getTotalExperience(target.getBase()), target.getLevel(), SetExpFix.getExpUntilNextLevel(target.getBase())));
	}
	...
	private void setExp(final CommandSource sender, final User target, String strAmount, final boolean give) throws NotEnoughArgumentsException
	{
		...
		sender.sendMessage(tl_("expSet", target.getDisplayName(), amount));
	}
}
