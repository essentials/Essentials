...
public class Commandrepair extends EssentialsCommand
{
	...
	public void repairHand(User user) throws Exception
	{
		...
		{
			throw new Exception(tl_("repairInvalidType"));
		}
		...
		{
			throw new Exception(tl_("repairEnchanted"));
		}
		...
		user.sendMessage(tl_("repair", itemName.replace('_', ' ')));
	}
	...
	public void repairAll(User user) throws Exception
	{
		...
		if (repaired.isEmpty())
		{
			throw new Exception(tl_("repairNone"));
		}
		else
		{
			user.sendMessage(tl_("repair", StringUtil.joinList(repaired)));
		}
	}
	...
	private void repairItem(final ItemStack item) throws Exception
	{
		...
		{
			throw new Exception(tl_("repairAlreadyFixed"));
		}
