...
/**
 * The
 * <code>PaymentMethods</code> initializes PaymentMethods that utilize the Method interface based on a "first come, first served"
 * basis.
 *
 * Allowing you to check whether a payment method exists or not.
 *
 * PaymentMethods also allows you to set a preferred method of payment before it captures payment plugins in the initialization
 * process.
 *
 * in
